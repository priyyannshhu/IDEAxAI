...
const blueprintSections = [
  { key: "startupOverview", title: "Startup Overview", icon: Lightbulb, gradient: "from-amber-400 to-orange-500" },
  { key: "problemStatement", title: "Problem Statement", icon: AlertTriangle, gradient: "from-red-400 to-rose-500" },
  { key: "targetAudience", title: "Target Audience", icon: Users, gradient: "from-blue-400 to-indigo-500" },
  { key: "mvpFeatures", title: "MVP Features", icon: Layers, gradient: "from-indigo-400 to-violet-500" },
  { key: "techStack", title: "Tech Stack", icon: Cpu, gradient: "from-cyan-400 to-teal-500" },
  { key: "revenueModel", title: "Revenue Model", icon: DollarSign, gradient: "from-emerald-400 to-green-500" },
  { key: "marketingStrategy", title: "Marketing Strategy", icon: Megaphone, gradient: "from-pink-400 to-rose-500" },
  { key: "competitorAnalysis", title: "Competitor Analysis", icon: Trophy, gradient: "from-purple-400 to-fuchsia-500" },
  { key: "uniqueValueProposition", title: "Unique Value Proposition", icon: Star, gradient: "from-yellow-400 to-amber-500" },
  { key: "validationStrategy", title: "Validation Strategy", icon: CheckCircle, gradient: "from-teal-400 to-cyan-500" },
  { key: "developmentRoadmap", title: "Development Roadmap", icon: Map, gradient: "from-violet-400 to-purple-500" },
] as const;
...
export default function Generator() {
  ...
  const handleGenerate = async () => {
    if (!idea.trim() || idea.trim().length < 10) {
      setError("Please describe your startup idea in more detail (at least 10 characters)");
      return;
    }
    ...
    try {
      const response = await fetch(`${import.meta.env.VITE_API_URL}/api/generate-blueprint`, {
        method: "POST",
        ...
        <div className="max-w-5xl mx-auto">
          ...
          >
            ...
            <p className="text-lg text-white/50 max-w-2xl mx-auto">
              Describe your startup idea and let AI create a comprehensive blueprint including MVP features, tech stack, revenue models, and more.
            </p>
          </motion.div>
            ...
            {blueprint && (
              ...
              >
                <div className="text-center mb-8">
                  ...
                  <p className="text-white/50">Generated AI analysis for your startup idea</p>
                </div>

                <div className="grid gap-6">
                  {blueprintSections.map((section, index) => {
                    const content = blueprint[section.key as keyof StartupBlueprint];
                    ...
                    return (
                      ...
                      >
                        <div className="glass rounded-2xl p-6 hover:border-white/20 transition-all duration-300">
                          <div className="flex items-start gap-4">
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center justify-between mb-3">
                                ...
                                <button
                                  onClick={() => copyToClipboard(section.key, content)}
                          ...
                          {/* Hover glow */}
                          <div className={`absolute -inset-px rounded-2xl bg-gradient-to-br ${section.gradient} opacity-0 group-hover:opacity-5 blur-xl transition-opacity duration-500 -z-10`} />
                        </div>
                      </motion.div>
                    );
                  })}
            ...
            >
              <div className="flex flex-col items-center gap-6">
                ...
                <div className="text-center">
                  <p className="text-xl text-white font-medium mb-2">Generating your blueprint...</p>
                  <p className="text-white/50">AI is analyzing your idea and creating comprehensive insights</p>
                </div>
